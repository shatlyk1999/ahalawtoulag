...
(function ( $, window, document, undefined ) {
    ...
    function currentDate()
    {
        ...
        var currnetUrl = new URL(location);

                    var lastParam = currnetUrl.searchParams.get('date');

                    if (currnetUrl.searchParams.has('date') && currnetUrl.searchParams.get('date').length > 0) {
                        var test = new Date(lastParam);                      
        ...
        buildCalendar: function (fromDate, calendar) {
            ...
            for(var day = firstDay; day <= lastDay; day.setDate(day.getDate())) {
                ...
                for(var i = 0; i<7; i++) {
                    ...
                    var date =  fromDate.getFullYear() + "-"+ month + "-" + dd ;
                    
                    var url = new URL(currnetUrl);

                    var lastParam = url.searchParams.get('date');


                    url.searchParams.set('date', date);

                    var td = $('<td><a href="'+url+'" class="day">'+day.getDate()+'</a></td>');
