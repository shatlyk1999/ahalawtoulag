    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12" style="margin: 65px 0 80px;">
                    <form action="{{route('order_truck')}}" method="post">
                        @csrf
                        @php
                        unset($all['_token']);
                        $all['price'];
                        ...
                        <div class="list-group">
                            <ul>
                                ...
                                <li class="list-group-item list-group-item-light"><b>Ýüküň görnüşi: </b>{{ $all['yuk_gornush'] }}</li>
                                <li class="list-group-item list-group-item-light"><b>Ýüküň agramy (tonna): </b>{{ $all['yuk_agram'] }}</li>
